...
def _done_gate_review_brief(goal: "Goal") -> str:
    ...
    return (
        ...
        "   - Edits to gate inputs — AGENTS.md, CI workflows, test-runner or "
        "build configuration, install scripts, committed binaries. Those "
        "files feed the verification; they are never evidence for a clause.\n\n"
