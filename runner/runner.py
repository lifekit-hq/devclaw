...
_KIND_WRAPPERS = {
    ...
    "onboard": (
        ...
        "  IMPORTANT: include EXPLICIT markdown links in the AGENTS.md body to "
        "[ARCHITECTURE.md](./ARCHITECTURE.md), [.agent/skills/](./.agent/skills/), "
        "and [specs/](./specs/) — but only for paths that ACTUALLY EXIST in the "
        "repo. A component map nothing links to doesn't help a worker exploring.\n"
