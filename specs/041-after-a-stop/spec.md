...
**Status**: SHIPPED — US1 + US2 implemented 2026-09-08 (stacked PR); amended by spec 045 (2026-09-10): an owner accept_close is not outranked by the evaluator's own `auto-eval` rows; they ride the close as follow-ups.
