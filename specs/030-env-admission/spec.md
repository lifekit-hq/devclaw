...
**Status**: SHIPPED — 2026-09-02. Generalized by spec 032 (2026-09-03): the capability set gains `ci:definition` (implicit for every registered project) and worker-reported `worker:<item>` rows; the same `mechanical:env` seam holds and heals both.
