...
**Status**: SHIPPED — 2026-08-31 — shipped in #703, #704, #705, #706, #773 (tasks 30/30); the deploy remainder (T029/T030 — sandbox-image rebuild + live proofs) is owned by open issue #717. Header corrected 2026-09-06 by the docs audit (it read Draft after the work had shipped).
