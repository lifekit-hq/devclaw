...
- [x] T012 Delete `devclaw/queue/programs.py` DAG machinery + `devclaw/goal/fanout.py`
- [x] T013 Delete `tests/test_program_plan.py`, `tests/test_queue_dag.py`, `tests/test_start_program_alias.py`, `tests/test_cancel_program_guard.py`, `tests/test_fanout_plan.py`, `tests/test_fanout_integration.py`
- [x] T014 Remove program/fanout cases from `tests/test_goal_tick.py`, `tests/test_cancel.py`, `tests/test_goal_engine.py`, `tests/goal_fakes.py`
