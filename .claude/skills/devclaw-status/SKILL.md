...
6. **Trends** — retired 2026-09-06 (spec 037): there is no trend detector and no `review_trends` tool; skip this section.
...
- **Trends** — the detector and `review_trends` were retired 2026-09-06 (spec 037); no trend section in the digest.