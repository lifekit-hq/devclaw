...
| `DEVCLAW_GOAL_DECOMPOSE` | `0` | Migration flag: an executing goal's `done_when` is decomposed into a structured checklist up front (Shape 2 / Pillar 1) as one structured plan (used by the one_shot dial). |
